...
public class PaymentController extends BaseController {
	...
	public Map<String, String> payOrder(int amount, String contents, String cardNumber, String cardHolderName,
			String expirationDate, String securityCode, String paymentType) {
		Map<String, String> result = new Hashtable<String, String>();
		result.put("RESULT", "PAYMENT FAILED!");
		try {
			if (paymentType == Configs.CREDIT_CARD)
				this.card = new CreditCard(cardNumber, cardHolderName, Integer.parseInt(securityCode),
					getDate(expirationDate));
			else if (paymentType == Configs.DEBIT_CARD)
				this.card = new DebitCard(cardNumber, cardHolderName, Integer.parseInt(securityCode),
						getDate(expirationDate));
