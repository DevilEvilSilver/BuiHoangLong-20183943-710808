...
import utils.NewShippingFee;
import utils.OldShippingFee;
import utils.RushShippingFee;
import utils.ShippingFeeCaculator;
...
public class PlaceRushOrderController extends BaseController{
     ...
     */
    private ShippingFeeCaculator shippingFee;
...
//    	check if name is null
    ...
    public int calculateShippingFee(Order order){
    	shippingFee = new RushShippingFee();
    	return shippingFee.calculateShippingFee(order);
    }
}
