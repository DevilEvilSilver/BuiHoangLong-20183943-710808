...
public class CartScreenHandler extends BaseScreenHandler {
	...
	public void requestToPlaceRushOrder() throws SQLException, IOException {
		try {
			...
			// create order
			RushOrder order = placeRushOrderController.createRushOrder();

			// display shipping form
			RushShippingScreenHandler RushShippingScreenHandler = new RushShippingScreenHandler(this.stage, Configs.RUSH_SHIPPING_SCREEN_PATH, order);
